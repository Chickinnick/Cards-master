...
public class RearrangeableLayout extends ViewGroup {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mSelectedChild != null && mStartTouch != null && mListener != null) {
                    LayoutParams lp = (LayoutParams) mSelectedChild.getLayoutParams();
                    ...
                    mListener.onChildStartMoving(mSelectedChild, mChildStartRect, mChildEndRect);
    ...
    public interface ChildPositionListener {
        ...
        void onChildStartMoving(View mSelectedChild, Rect mChildStartRect, Rect mChildEndRect);
    }
